...
public class ButtonElement {
    ...
    @JoinColumn(name = "VIEW_id", insertable = true, updatable = true, unique = false, nullable = true, referencedColumnName = "ID", foreignKey = @ForeignKey(name = "FK_VIEW_BUTTON_ELEMENT"))
